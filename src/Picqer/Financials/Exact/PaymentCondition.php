 ...
 * @property Int32 $PaymentDays Number of days to be included in the due date calculation. Example: invoice date = 17/01 PaymentEndOfMonths = 2 => 31/03 PaymentDays = 15 => 15/04
 * @property String $PaymentDiscountType Type of payment discount. Values: B = Settlement discount, K = Credit surcharge
 * @property Int32 $PaymentEndOfMonths Number of month endings to be included in the due date calculation
 * @property String $PaymentMethod Method of payment. Values: B = On credit, I = Collection, K = Cash
 * @property Double $Percentage Percentage (stored as fraction) of total invoice amount
