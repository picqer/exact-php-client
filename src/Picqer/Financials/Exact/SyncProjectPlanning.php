...
/**
 * Class SyncProjectPlanning.
 *
 * @see https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncProjectProjectPlanning
 *
 ...
 */
class SyncProjectPlanning extends Model
{
    use Query\Findable;
    ...
    protected $url = 'sync/Project/ProjectPlanning';
}
