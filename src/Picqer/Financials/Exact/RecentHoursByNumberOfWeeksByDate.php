 ...
 *
 * @see https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=ReadProjectRecentHoursByNumberOfWeeksByDate
 *
 ...
 */
class RecentHoursByNumberOfWeeksByDate extends Model
{
    use Query\Findable;
    ...
    protected $url = 'read/project/RecentHoursByNumberOfWeeksByDate';
}
