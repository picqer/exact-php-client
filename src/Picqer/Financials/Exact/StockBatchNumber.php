 ...
 * @property string $PickOrderLine ID of pick order entry in which this batch number was used
 * @property float $Quantity Quantity of this batch number entering or leaving inventory
 * @property string $Remarks Remarks
 * @property string $SalesReturnLine ID of sales return entry in which this batch number was used
