...
/**
 * Class SyncLeaveBuildUpRegistration.
 *
 * @see https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncHRMLeaveBuildUpRegistrations
 *
 ...
 */
class SyncLeaveBuildUpRegistration extends Model
{
    use Query\Findable;
    ...
    protected $url = 'sync/HRM/LeaveBuildUpRegistrations';
}
