 ...
 * @property string $CustomerDemandsDescription Description related to customer demand
 * @property string $DecisionMakingUnitName DMU fields-Unit Name
 * @property string $DecisionMakingUnitRole DMU fields- Unit Role
 * @property string $DecisionTimeframe Description of the time frame
 * @property string $DispatchToSales Indicate the date when dispatch to sales
 * @property int $Division Division code
 * @property int $IsAssociatedPrice Aware of associated prices
 * @property int $IsCustomerDemandsMeet Standard product solves customer demands
 * @property string $LeadDeveloper Name of the lead developer
 ...
 */
class HostingOpportunity extends Model
{
    use Query\Findable;
    ...
    protected $url = 'crm/HostingOpportunities';
}
