...
/**
 * Class IndicatorBalance.
 *
 * @see https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=ContinuousMonitoringIndicatorBalances
 *
 ...
 */
class IndicatorBalance extends Model
{
    use Query\Findable;
    ...
    protected $url = 'beta/{division}/continuousmonitoring/IndicatorBalances';
}
