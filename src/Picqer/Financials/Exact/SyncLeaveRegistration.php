...
/**
 * Class SyncLeaveRegistration.
 *
 * @see https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncHRMLeaveRegistrations
 *
 ...
 */
class SyncLeaveRegistration extends Model
{
    use Query\Findable;
    ...
    protected $url = 'sync/HRM/LeaveRegistrations';
}
