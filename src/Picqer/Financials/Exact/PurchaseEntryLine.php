 ...
 * @property string $IntraStatTransactionB IntraStat transaction B (only relevant when IntraStat for purchase is enabled in the Luxembourg, France & United Kingdom administration)
