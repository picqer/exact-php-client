...
/**
 * Class SyncAbsenceRegistrationTransaction.
 *
 * @see https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncHRMAbsenceRegistrationTransactions
 *
 ...
 */
class SyncAbsenceRegistrationTransaction extends Model
{
    use Query\Findable;
    ...
    protected $url = 'sync/HRM/AbsenceRegistrationTransactions';
}
