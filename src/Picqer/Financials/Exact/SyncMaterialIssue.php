...
/**
 * Class SyncMaterialIssue.
 *
 * @see https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SyncManufacturingMaterialIssues
 *
 ...
 */
class SyncMaterialIssue extends Model
{
    use Query\Findable;
    ...
    protected $url = 'sync/Manufacturing/MaterialIssues';
}
