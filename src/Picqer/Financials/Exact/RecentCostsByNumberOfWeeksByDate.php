 ...
 *
 * @see https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=ReadProjectRecentCostsByNumberOfWeeksByDate
 *
 ...
 */
class RecentCostsByNumberOfWeeksByDate extends Model
{
    use Query\Findable;
    ...
    protected $url = 'read/project/RecentCostsByNumberOfWeeksByDate';
}
