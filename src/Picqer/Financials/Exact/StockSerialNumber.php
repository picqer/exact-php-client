 ...
 * @property Guid $DraftStockTransactionID ID representing a group of serial numbers being reserved for use in a subsequent stock transaction
 ...
 * @property Byte $IsDraft Boolean value indicating if this serial number is being reserved
 ...
 * @property Guid $SerialNumberID Serial number ID
 ...
 * @property Guid $Warehouse Warehouse which this serial number is entering or leaving
