 ...
 * @property string $EndDate End date of effective period for serial/batch number
 * @property string $ID A guid that is the unique identifier of the serial/batch number
 * @property int $IsBlocked Boolean value indicating whether or not the serial/batch number is blocked
 ...
 * @property string $SerialBatchNumber Human readable serial/batch number
