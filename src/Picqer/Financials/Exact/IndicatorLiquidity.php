...
/**
 * Class IndicatorLiquidity.
 *
 * @see https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=ContinuousMonitoringIndicatorLiquidities
 *
 ...
 */
class IndicatorLiquidity extends Model
{
    use Query\Findable;
    ...
    protected $url = 'beta/{division}/continuousmonitoring/IndicatorLiquidities';
}
